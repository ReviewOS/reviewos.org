...
declare module 'bun' {
  namespace env {
    ...
    const GIT_HOOK_SECRET: string
    const GIT_HOOK_URL: string
    ...
    const TYPESENSE_API_KEY: string
    const TYPESENSE_HOST: string
    const TYPESENSE_PORT: number
    const TYPESENSE_PROTOCOL: string
  }
}
...
declare module '@stacksjs/env' {
  interface StacksEnv {
    ...
    TYPESENSE_PROTOCOL: string | undefined
  }
}
