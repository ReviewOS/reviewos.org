...
| [01 - Foundation](./01-foundation.md) | Users, organizations, teams, tokens, keys | Done (68/68) |
...
| [07 - Marketing and docs](./07-marketing-docs.md) | Landing page, documentation, self-hosting guide | In progress (48/56) |
| [08 - Migration](./08-migration.md) | Importing from GitHub and other forges | Done (16/16) |
| [09 - Checks and CI](./09-checks-ci.md) | Checks, durable execution, runner providers, deployments | Started (40/120) |
...
| [15 - Pipelines](./15-pipelines.md) | Actions compatibility, step model, runner fleet, test intelligence | Started (176/189) |
| [16 - Single-node hardening](./16-hardening-scale.md) | Bounded buffers, backpressure, process ceilings, pantry-first infra | In progress (25/34) |
