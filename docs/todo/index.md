...
| [07 - Marketing and docs](./07-marketing-docs.md) | Landing page, documentation, self-hosting guide | In progress (24/46) |
| [08 - Migration](./08-migration.md) | Importing from GitHub and other forges | Done (16/16) |
| [09 - Checks and CI](./09-checks-ci.md) | Checks, durable execution, runner providers, deployments | Started (38/120) |
...
| [15 - Pipelines](./15-pipelines.md) | Actions compatibility, step model, runner fleet, test intelligence | Started (2/189) |
