...
describe('the migration corpus', () => {
  ...
  it('contains no hand-written commentary', () => {
    // The generator now stamps its own header - `-- @generated by ...` - which
    // is the opposite of the thing this forbids: it is the file saying it is
    // disposable. Exempted by matching the marker rather than by allowing the
    // first line, so a hand-written comment under a generated header is still
    // caught.
    const generatedHeader = /^--\s*@generated\b.*$/gm
